# (Unofficial) eBay API client (PHP) - Sell / Analytics
...
Starting from version 1.2.0, this project will match according eBay API's versioning. Should you found a matching 
